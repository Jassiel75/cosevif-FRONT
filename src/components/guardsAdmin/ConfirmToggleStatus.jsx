...
function ConfirmToggleStatus({ show, handleClose, handleConfirm, guardName, guardStatus }) {
  if (!show) return null // No renderiza nada si el modal no está visible

  const isActivating = !guardStatus
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="alert alert-warning mt-3">
              <small>
                <FaExclamationTriangle className="me-1" /> Al {actionText} este guardia, {consequenceText}.
              </small>
            </div>
          </div>
...
export default ConfirmToggleStatus
